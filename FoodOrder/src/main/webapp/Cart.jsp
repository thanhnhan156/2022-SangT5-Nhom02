                                        ...
                                        <table class="table">
                                            ...
                                            <c:forEach begin="1" end="3" var="o">
                                                <tr>
                                                    <th scope="row">
                                                        <div class="p-2">
                                                            <img src="https://www.rinnoo.net/f/res/h08/articles-photos/000/779/0077910-343-rinnoo-f2240471f2984527afcf360dcec7829f.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
                                                            <div class="ml-3 d-inline-block align-middle">
                                                                <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block">Hambeger</a></h5><span class="text-muted font-weight-normal font-italic"></span>
                                                            </div>
                                                        </div>
                                                    </th>
